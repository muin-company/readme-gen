...
export function generateReadme(info: ProjectInfo, badgeConfig?: BadgeConfig, template: TemplateType = 'standard'): string {
  ...
  switch (template) {
    case 'minimal':
      return generateMinimal(info, sections, badgeConfig);
    case 'detailed':
      return generateDetailed(info, sections, badgeConfig);
    case 'comprehensive':
      return generateComprehensive(info, sections, badgeConfig);
    case 'standard':
    default:
      return generateStandard(info, sections, badgeConfig);
  }
}

// Minimal template: Just the essentials
function generateMinimal(info: ProjectInfo, sections: string[], badgeConfig?: BadgeConfig): string {
  // Installation
...
function generateStandard(info: ProjectInfo, sections: string[], badgeConfig?: BadgeConfig): string {
  // Badges
...
function generateDetailed(info: ProjectInfo, sections: string[], badgeConfig?: BadgeConfig): string {
  // Badges
  const badges = generateBadgesSection(info, badgeConfig);
  if (badges) {
    sections.push(badges);
...
function generateComprehensive(info: ProjectInfo, sections: string[], badgeConfig?: BadgeConfig): string {
  // Badges
  const badges = generateBadgesSection(info, badgeConfig);
  if (badges) {
    sections.push(badges);
